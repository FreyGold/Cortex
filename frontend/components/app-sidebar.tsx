      ...
      <div className="flex-1 px-3 space-y-8 mt-4 overflow-y-auto custom-scrollbar">
        {isDailyPage ? (
          <div className="space-y-1 animate-in fade-in slide-in-from-left-4 duration-300">
            ...
            />
            <div className="pt-4 pb-2 px-3 text-[10px] font-bold uppercase tracking-widest text-muted-foreground/30">
              Daily Track
            </div>
            <NavButton
              icon={CalendarDays}
          ...
          <div className="space-y-1 animate-in fade-in duration-300">
            ...
            <div className="pt-6 px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-muted-foreground/30">
              Account
            </div>
            <NavButton
              icon={Settings}
