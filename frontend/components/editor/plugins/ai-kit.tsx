...
export const aiChatPlugin = AIChatPlugin.extend({
  ...
  useHooks: ({ editor, getOption }) => {
    ...
    let rawMarkdown = editor.getOption(AIChatPlugin, '_rawMarkdown') || '';
    let lastInsertedLength = editor.getOption(AIChatPlugin, '_lastInsertedLength') || 1;
      ...
      onChunk: ({ chunk, isFirst, text: content }) => {
        ...
        if (isFirst && mode === 'insert') {
          ...
          editor.tf.withoutSaving(() => {
            ...
            editor.setOption(AIChatPlugin, '_blockPath', newPath);
          });
          ...
          editor.tf.withoutSaving(() => {
            ...
            editor.tf.withScrolling(() => {
              editor.tf.withoutNormalizing(() => {
                ...
                const parsedNodes = deserializeMd(editor, newMarkdown) as any[];
