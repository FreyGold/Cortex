...
export function ResourceDialog({ courseId, doctors: initialDoctors, isAdmin = false }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="w-full gap-2 mt-4 rounded-xl font-bold bg-primary/10 text-primary border-none hover:bg-primary hover:text-white transition-all shadow-lg shadow-primary/5" variant="outline">
        ...
        <form onSubmit={onSubmit}>
          <div className="p-8 space-y-6">
            <header className="space-y-1">
                <DialogTitle className="text-2xl font-bold tracking-tight">Add Resource</DialogTitle>
            ...
            <div className="grid gap-5">
                ...
                <Input id="title_en" name="title_en" required placeholder="e.g. Midterm 2023" className="rounded-xl h-11 border-border/40 focus:ring-primary/20" />
                </div>
                ...
                {resourceType !== "note" && (
                    ...
                    <Input id="google_drive_url" name="google_drive_url" required placeholder="Paste full Google Drive link" className="rounded-xl h-11 border-border/40 focus:ring-primary/20" />
                    </div>
                )}
            </div>
          </div>
          <DialogFooter className="bg-muted/10 p-6 pt-4 border-t border-border/5">
            <Button type="submit" disabled={isLoading} className="w-full rounded-2xl h-12 font-bold text-base shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98]">
